...
public class CircleBamfuraImanView extends FarrasImagemView {
    ...
    public CircleBamfuraImanView(Context context) {
        super(context);

        init();
    }

    public CircleBamfuraImanView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleBamfuraImanView(Context context, AttributeSet attrs, int defStyle) {
